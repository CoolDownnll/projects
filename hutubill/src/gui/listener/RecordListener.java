...
public class RecordListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(0 == p.cbModel.cs.size()){
            ...
            MainPanel.instance.workingPanel.show(CategoryPanel.instance);  // 切换到CategoryPanel
            return;
        }
        ...
        MainPanel.instance.workingPanel.show(SpendPanel.instance);  // 切换到SpendPanel
    }
